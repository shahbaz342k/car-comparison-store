...
const SEOHead = ({ title, description, cars = [] }) => {
  ...
  return (
    <Helmet>
      <title>{title || "Car Comparison App"}</title>
      <meta name="description" content={description || "Compare different car models by attributes"} />
      <meta property="og:title" content={title} />
      <meta property="og:description" content={description} />
      <meta property="og:type" content="website" />
      <meta property="og:site_name" content="CarCompare Dashboard" />
